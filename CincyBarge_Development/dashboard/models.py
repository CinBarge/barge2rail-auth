...
class RawProductData(models.Model):
    ...
    supplier = models.ForeignKey(
        Supplier, on_delete=models.CASCADE, related_name="raw_data"
    )
...
class BillOfLading(models.Model):
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, related_name="created_bols"
    )
...
class Order(models.Model):
    ...
    delivery_date = models.DateField(
        null=True, blank=True, help_text="Scheduled delivery date"
    )
