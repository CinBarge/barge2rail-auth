...
from .models import Supplier, BillOfLadingTemplate, BillOfLading, BillOfLadingLineItem, Product
...
class BillOfLadingTemplateForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'template_file': forms.FileInput(attrs={'class': 'form-control', 'accept': '.pdf'}),
    ...
    def clean_template_file(self):
        ...
        if file:
            ...
            if file_extension != 'pdf':
                raise forms.ValidationError("Only PDF files are allowed for BOL templates.")
...
class BillOfLadingForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'freight_charges', 'delivery_date', 'notes'
        ]
        widgets = {
            'supplier': forms.Select(attrs={'class': 'form-control'}),
            ...
            'freight_charges': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01'}),
