...
from sso.models import Application, AuthorizationCode, UserRole
...
def cleanup_old_applications():
    ...
    old_apps = Application.objects.exclude(name="PrimeTrade").exclude(
...
def ensure_primetrade_setup():
    ...
    try:
        ...
        role, created = UserRole.objects.get_or_create(
            user=user, application=app, defaults={"role": "admin"}
        )
