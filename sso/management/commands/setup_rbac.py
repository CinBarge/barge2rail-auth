...
APP_DEFINITIONS = {
    "senco": {
        "features": [
            {"code": "dashboard", "name": "Dashboard", "description": "Main dashboard"},
            {
                "code": "schedule",
                "name": "Schedule",
                "description": "Delivery schedule",
            },
            {"code": "scan", "name": "Scan", "description": "Barcode scanning"},
            {"code": "bol", "name": "BOL", "description": "Bill of Lading"},
            {
                "code": "receiving",
                "name": "Receiving",
            ...
            {"code": "admin", "name": "Admin", "description": "Administration"},
        ],
        "roles": [
            {
                "code": "senco_admin",
                ...
                "permissions": {
                    ...
                    "scan": ["view", "create", "modify", "delete", "export"],
                    "bol": ["view", "create", "modify", "delete", "export"],
                    "receiving": ["view", "create", "modify", "delete", "export"],
            ...
            },
            {
                "code": "senco_office",
                "name": "Senco Office",
                "description": "Daily operations (all except admin, no delete)",
                "legacy_role": "Office",
                "permissions": {
                    "dashboard": ["view", "create", "modify"],
                    "schedule": ["view", "create", "modify"],
                    "scan": ["view", "create", "modify"],
                    "bol": ["view", "create", "modify"],
                    "receiving": ["view", "create", "modify"],
            ...
            },
            {
                "code": "senco_operator",
                "name": "Senco Operator",
                "description": "Field scanning and inventory view",
                "legacy_role": "Operator",
                "permissions": {
                    "dashboard": ["view"],
                    "schedule": ["view"],
                    "scan": ["view", "create", "modify", "delete"],
                    "bol": [],
                    "receiving": [],
                    "inventory": ["view"],
                    "shipments": [],
            ...
            {
                "code": "senco_scheduler",
                "name": "Senco Scheduler",
                "description": "Schedule management and receiving",
                "legacy_role": "",
                "permissions": {
                    "dashboard": ["view"],
