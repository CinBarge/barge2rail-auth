...
class AssignAdminPermissionsTests(TestCase):
    ...
    @override_settings(ADMIN_WHITELIST="test@example.com", SUPERUSER_WHITELIST="")
    ...
    @override_settings(
        ADMIN_WHITELIST="test@example.com", SUPERUSER_WHITELIST="test@example.com"
    )
    ...
    @override_settings(ADMIN_WHITELIST="*@example.com", SUPERUSER_WHITELIST="")
