...
if response.status_code == 302:
    ...
    full_login_url = login_url if login_url.startswith('http') else f"{SSO_BASE}{login_url}"
    ...
    if response.status_code == 302:
        ...
        full_authorize_url = authorize_redirect if authorize_redirect.startswith('http') else f"{SSO_BASE}{authorize_redirect}"
